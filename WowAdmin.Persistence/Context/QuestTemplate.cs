...
public partial class QuestTemplate
{
    ...
    public ushort SrcSpell { get; set; }
    ...
    public uint ReqSourceCount1 { get; set; }

    public uint ReqSourceCount2 { get; set; }

    public uint ReqSourceCount3 { get; set; }

    public uint ReqSourceCount4 { get; set; }
    ...
    public ushort ReqSpellCast1 { get; set; }

    public ushort ReqSpellCast2 { get; set; }

    public ushort ReqSpellCast3 { get; set; }

    public ushort ReqSpellCast4 { get; set; }
